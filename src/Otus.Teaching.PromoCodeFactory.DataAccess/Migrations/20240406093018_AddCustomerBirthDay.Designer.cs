...
namespace Otus.Teaching.PromoCodeFactory.DataAccess.Migrations
{
    ...
    [Migration("20240406093018_AddCustomerBirthDay")]
            ...
            modelBuilder.Entity("Otus.Teaching.PromoCodeFactory.Core.Domain.CustomerPreference", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Id = new Guid("9c4982a0-763b-4985-876d-1bba466fa599")
                        },
                        new
                        {
                            CustomerId = new Guid("a6c8c6b1-4349-45b0-ab31-244740aaf0f0"),
                            PreferenceId = new Guid("c4bda62e-fc74-4256-a956-4760b3858cbd"),
                            Id = new Guid("78ed9ab1-3adb-4de5-9d29-4deb45c53600")
                        });
                });
            ...
            modelBuilder.Entity("Otus.Teaching.PromoCodeFactory.Core.Domain.PromoCodeManagement.PromoCode", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("738cbbe9-dbd4-46f3-95fe-032c08470128"),
                            BeginDate = new DateTime(2024, 3, 27, 12, 30, 18, 230, DateTimeKind.Local).AddTicks(6775),
                            Code = "THEATER-123",
                            CustomerId = new Guid("a6c8c6b1-4349-45b0-ab31-244740aaf0f0"),
                            EndDate = new DateTime(2024, 5, 6, 12, 30, 18, 230, DateTimeKind.Local).AddTicks(6790),
                        ...
                        new
                        {
                            Id = new Guid("a51b578d-81fb-4d93-a27a-d38faeae4d77"),
                            BeginDate = new DateTime(2024, 3, 27, 12, 30, 18, 230, DateTimeKind.Local).AddTicks(6819),
                            Code = "FAMILY-456",
                            CustomerId = new Guid("a6c8c6b1-4349-45b0-ab31-244740aaf0f0"),
                            EndDate = new DateTime(2024, 6, 5, 12, 30, 18, 230, DateTimeKind.Local).AddTicks(6820),
                            PartnerManagerId = new Guid("f766e2bf-340a-46ea-bff3-f1700b435895"),
                            PreferenceId = new Guid("c4bda62e-fc74-4256-a956-4760b3858cbd"),
